...
# print(ДатаВремя) --[записывает ДатаВремя в файл stdout]--> stdout --[выводит ДатаВремя в консоль]--> консоль
...
#import sys
# ДатаВремя = [line.strip() for line in sys.stdin]
# или
#ДатаВремя = list(map(str.strip, sys.stdin))
