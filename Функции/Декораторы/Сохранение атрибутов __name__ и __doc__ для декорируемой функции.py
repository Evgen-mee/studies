...
# все функции содержат специальные 1 Атрибуты
...
# её 1 Атрибуты __name__ и __doc__ изменились на имя и строку внутренней функции wrapper()
#
...
# import functools
# def bold(func):
#     @functools.wraps(func) # 1 Атрибуты __name__ и __doc__ не перетираются после применения декоратора bold
#     def wrapper(*args, **kwargs):
#         return '<b>' + func(*args, **kwargs) + '</b>'
#     return wrapper
# @bold
