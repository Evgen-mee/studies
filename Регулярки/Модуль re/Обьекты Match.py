...
#  - expand(template)
# работает почти как функция sub() с группами
# заменяет найденные вхождения на заданные символы и возвращает исправленную строку
#
# match.expand()
# генерирует строку, путём вставки в неё значений из найденных групп.
# удобно генерировать строки с найденными данными.
#
# re.sub()
# ищет совпадения в тексте, если совпадения найдены, то генерирует строку,
# путём вставки в неё значений из найденных групп,
# и заменяет совпадения на сгенерированные строки.
#
#
# import re
